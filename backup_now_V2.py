...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.progress.setGeometry(30, 350, 710, 30)
    ...
    def select_dest(self):    
        print('dest_selected')
        self.save_name = str(QtGui.QFileDialog.getSaveFileName(Dialog, "Save Project File", "", " Zip File (*.zip)"))
    ...
    def backup(self):
        ...
        for subdir, dirs, files in os.walk(source_folder):
            ...
            #curdir = subdirs.split('\\')[1] #The directory os.walk is currently in.            
            for file in files:
